...
description: "Learning is the stated goal of every ed-tech company. Why does engagement keep winning?"
date: 2026-01-13
status: "exploring"
tags:
    - Ed-Tech
...
Even with robust and defensible learning metrics, they would still be slow to move, hard to explain, and uncomfortable when they don't improve.
...
But pretending the problem is unsolved because teams don't care enough, or because metrics are not sophisticated enough, is a convenient simplification. It is also a disservice to the learners these products claim to serve.
